...
public class KeycloakTestSupport {
    ...
    public static KeycloakContainer createKeycloakContainer(String realmImportFileName) {
        return createKeycloakContainer("quay.io/keycloak/keycloak:25.0.6", realmImportFileName);
    }
...
//                    .withEnv("KC_HTTPS_CERTIFICATE_FILE", "./config/stage/dev/tls/acme.test+1.pem")
//                    .withEnv("KC_HTTPS_CERTIFICATE_KEY_FILE", "./config/stage/dev/tls/acme.test+1-key.pem")
    ...
    public static GenericContainer<?> createKeycloakConfigCliContainer(KeycloakContainer keycloakContainer) {
        ...
        var keycloakConfigCli = new GenericContainer<>(
                "quay.io/adorsys/keycloak-config-cli:6.1.0-25.0.1"
        );
